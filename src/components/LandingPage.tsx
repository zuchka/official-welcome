...
export const LandingPage = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center px-5 py-20 bg-gradient-to-b from-gray-100 via-gray-200 to-gray-400">
      ...
      <h2 className="font-['Cormorant_Garamond'] text-[32px] md:text-[70px] lg:text-[100px] font-normal text-[#5B5B5B] tracking-[16px] md:tracking-[32px] lg:tracking-[48px] text-center mt-[60px] md:mt-[90px] lg:mt-[120px] max-w-full leading-tight">
        LOS ANGELES
      </h2>
